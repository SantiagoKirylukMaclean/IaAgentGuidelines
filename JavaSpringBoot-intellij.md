...
- Use hexagonal architecture with a one bounded context with application, domain and infrastructure inside.
- Do not add comments in class to explain code or functions, the code must be understable with a good namings
- Use functional programaing in the main functions to structure the code.
